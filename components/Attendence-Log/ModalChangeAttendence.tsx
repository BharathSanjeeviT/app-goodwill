...
const ModalChangeAttendence = ({ from, to, setFrom, setTo, CloseModal, setData }: {
  from: Date,
  to: Date,
    ...
    <View className="absolute top-0 left-0 bottom-0 z-10 w-[100vw] h-[100vh] flex justify-center items-center bg-[#00000050] px-3">
      ...
      <View className='bg-white p-5 rounded-lg border-2 flex justify-center items-center flex-col'>
        <Text className='text-lg font-semibold'>
          Choose Attendence Date
        </Text>
        <Text className='text-lg font-semibold my-3'>
          From {from.toDateString()} to {to.toDateString()}
        </Text>
        <View className='flex flex-row justify-between'>
          <TouchableOpacity className='bg-[#006dd6] p-3 mx-5 my-2 rounded-lg'
        ...
        <TouchableOpacity className='bg-[#ff9b00] p-3 mx-5 my-3 rounded-lg'
        ...
        <TouchableOpacity onPress={CloseModal} className='bg-[#ff9b00] p-3 mx-5 my-2 rounded-lg'>
          <Text className='text-center my-1'>
            Close
          </Text>
        </TouchableOpacity>
